...
## Import LUIS-modellen

Last ned en eksportert modell fra [EncyclopediaBot.json](https://github.com/vippsas/encyclopediabot-demo/tree/master/LUIS/EncyclopediaBot.json). Last opp denne modellen på [eu.luis.ai](https://eu.luis.ai): logg inn med en Microsoft bruker, og last opp JSON-filen fra Import New menyen
